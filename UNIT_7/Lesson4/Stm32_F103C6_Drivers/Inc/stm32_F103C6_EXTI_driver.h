...
typedef struct{
	...
	EXTI_GPIO_MAPPING_t EXIT_PIN;	   //specifies the extrenal interrupt GPIO Mapping
									   //This is parameter must e bases on @ref EXTI_define
	uint8_t 			Trigger_Case;  //specifies RISING or Falling or BOTH Trigger
	                                   //This is parameter must e bases on @ref EXTI_Trigger_define
	uint8_t 			IRQ_EN; 	   //Enable or Disable EXTI IRQ (That will enable IRQ MASK in EXTI and also on NVIC Interrupt Controller)
                                       //This is parameter must e bases on @ref EXTI_IRQ_define
...
//EXTI10
#define EXTI6PA10		(EXTI_GPIO_MAPPING_t){EXTI10,GPIOA,GPIO_PIN_10,EXTI10_IRQ}
#define EXTI6PB10		(EXTI_GPIO_MAPPING_t){EXTI10,GPIOB,GPIO_PIN_10,EXTI10_IRQ}
#define EXTI6PC10		(EXTI_GPIO_MAPPING_t){EXTI10,GPIOC,GPIO_PIN_10,EXTI10_IRQ}
#define EXTI6PD10		(EXTI_GPIO_MAPPING_t){EXTI10,GPIOD,GPIO_PIN_10,EXTI10_IRQ}
